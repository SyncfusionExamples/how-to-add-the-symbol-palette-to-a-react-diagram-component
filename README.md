...
A quick-start React project that shows how to add and customize the symbol palette in the [React Diagram](https://www.syncfusion.com/diagram-sdk/react-diagram) component. This project also includes code snippets for restricting the symbol palette's panel, customizing its symbol size, and customizing the symbol preview size.
